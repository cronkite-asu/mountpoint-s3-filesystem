<?php
/**
 * A class to extend the WordPress filesystem API to use the  Mountpoint S3 filesystem.
 *
 * @since 1.0.0
 */
...
class WP_Filesystem_MountpointS3 extends WP_Filesystem_Base {
	 ...
	 * Default to passing it to WP_Filesystem_Direct
	 *
	 * @param $filename
	 *
